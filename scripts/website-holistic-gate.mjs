 ...
 * Sets `NEXT_PUBLIC_APP_URL` to `productionCanonicalOrigin` from `config/marketing.json`
...
const anchorsPath = path.join(root, "config", "marketing.json");

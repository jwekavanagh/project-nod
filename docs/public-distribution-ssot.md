...
| `docs/discovery-guides.md` | SSOT for **indexable** `/guides/*` (from **`indexableGuides`**), Learn hub **`/guides`** (indexable), sitemap/`llms.txt` policy, redaction reference, GitHub templates | Yes |

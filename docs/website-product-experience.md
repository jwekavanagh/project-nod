...
- **Acquisition SSOT:** [`config/discovery-acquisition.json`](../config/discovery-acquisition.json) drives the README discovery fold (sync-written), extended **`/llms.txt`** sections (intent phrases, visitor problem answer, shareable URL), homepage hero title + CTA label/href ([`website/src/lib/discoveryAcquisition.ts`](../website/src/lib/discoveryAcquisition.ts), [`website/src/content/productCopy.ts`](../website/src/content/productCopy.ts)), and the citeable page **`/database-truth-vs-traces`** ([`website/src/app/database-truth-vs-traces/page.tsx`](../website/src/app/database-truth-vs-traces/page.tsx)). Schema: [`config/discovery-acquisition.schema.json`](../config/discovery-acquisition.schema.json). Do not hand-edit text inside README `<!-- discovery-acquisition-fold:start/end -->`; change JSON and run sync.

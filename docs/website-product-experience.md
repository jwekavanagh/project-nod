...
- **`/integrate` + `/integrate/guided`:** [`website/src/app/integrate/page.tsx`](../website/src/app/integrate/page.tsx) leads with a **Guided: generate registry and quick input** CTA to [`/integrate/guided`](../website/src/app/integrate/guided/page.tsx), then the pack-led `<pre>` with **`agentskeptic activate`** (+ replay **`crossing`**) from [`config/marketing.json`](../config/marketing.json) (`integratePage.packLedCommand`), requirements, proof, and GitHub links. Canonical prose for activation lives in [`docs/integrate.md`](../docs/integrate.md); [`docs/guided-first-verification.md`](../docs/guided-first-verification.md) is a stub pointer; adoption spine: [`docs/first-run-integration.md`](first-run-integration.md).

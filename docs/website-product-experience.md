...
3. After production deploy, verify **`{canonical}/llms.txt`**, **`{canonical}/database-truth-vs-traces`**, and **`{canonical}/security`** return **200** and that `llms.txt` lists both canonical and repo-raw OpenAPI / `llms.txt` links.

...
- **Homepage (non-commercial sections), CTA labels, test ids, account/integrate strings:** [`website/src/content/productCopy.ts`](../website/src/content/productCopy.ts). **Public commercial + contract copy** (pricing grid, “Commercial terms,” metering clarifier, security quick facts) live in [`website/src/lib/commercialNarrative.ts`](../website/src/lib/commercialNarrative.ts) with data from [`config/commercial-plans.json`](../config/commercial-plans.json).

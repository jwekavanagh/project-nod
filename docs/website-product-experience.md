...
- **`/integrate`:** [`website/src/app/integrate/page.tsx`](../website/src/app/integrate/page.tsx) renders a **GitHub README** link with **`data-testid="integrator-primary-cta"`** (canonical LangGraph reference blob URL from [`website/src/lib/langgraphReferenceReadmeUrl.ts`](../website/src/lib/langgraphReferenceReadmeUrl.ts)) **above** [`FirstRunActivationGuide`](../website/src/app/integrate/FirstRunActivationGuide.tsx), which is wrapped in **`data-testid="integrator-activation-commands"`**. The full prose guide remains inside a **`<details>`** element that is **closed by default**. Both bodies are **build-embedded** from [`docs/partner-quickstart-commands.md`](partner-quickstart-commands.md) and [`docs/first-run-integration.md`](first-run-integration.md) via [`scripts/sync-integrator-docs-embedded.mjs`](../scripts/sync-integrator-docs-embedded.mjs) into [`website/src/generated/integratorDocsEmbedded.ts`](../website/src/generated/integratorDocsEmbedded.ts) ( **`website` `prebuild`** ) so serverless deploys do not read the monorepo `docs/` tree at runtime.

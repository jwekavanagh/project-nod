...
- [README — Buy vs build: why not only SQL checks](../README.md#buy-vs-build-why-not-only-sql-checks) — recurring failure mode, **Quick → Contract** graduation
...
**Operator:** [Postgres verification (batch and CLI)](agentskeptic.md#postgres-verification-batch-and-cli).

**Validation:** [Adoption validation specification](adoption-validation-spec.md).

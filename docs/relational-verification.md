...
Row **must not exist** claims belong to **`sql_row_absent`** in the tool registry, not to **`sql_relational`** — see [`agentskeptic.md`](agentskeptic.md).

...
**First five minutes SSOT:** Checklist strings and doc drift guard are defined only in [`src/firstFiveMinutesChecklist.ts`](../src/firstFiveMinutesChecklist.ts); in-app copy imports that module.

...
- **Ruleset / branch protection** on `main`: required status checks (see `CONTRIBUTING.md` table) — align names with **`CI / verification`** (replacing the former separate **`CI / test`** and **`CI / commercial`** jobs).

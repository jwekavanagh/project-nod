...
**Join completeness:** Cross-surface numerators that correlate on **`funnel_anon_id`** assume the integrator followed [Funnel attribution (normative)](funnel-observability-ssot.md#funnel-attribution-normative) (`agentskeptic funnel-anon set` or the documented env override).

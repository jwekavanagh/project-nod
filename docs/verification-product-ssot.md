...
| **Shareable public reports** (`POST /api/public/verification-reports`, `GET /r/{id}`, `--share-report-origin`, envelope schema, operator env **`PUBLIC_VERIFICATION_REPORTS_ENABLED`**) | [`shareable-verification-reports.md`](shareable-verification-reports.md), [`schemas/public-verification-report-v1.schema.json`](../schemas/public-verification-report-v1.schema.json) | CLI exit semantics for share failures: [`workflow-verifier.md`](workflow-verifier.md); OpenAPI: [`schemas/openapi-commercial-v1.yaml`](../schemas/openapi-commercial-v1.yaml) |

...
describe.skipIf(!hasDatabaseUrl)("funnel persistence integration", () => {
  async function truncateAll(): Promise<void> {
    ...
    TRUNCATE magic_link_send_counter, verify_outcome_beacon, funnel_event, stripe_event, usage_reservation, usage_counter, api_key, session, account, "verificationToken", "user" RESTART IDENTITY CASCADE
  `);
  }

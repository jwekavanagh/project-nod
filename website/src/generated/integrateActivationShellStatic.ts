...
export const INTEGRATE_ACTIVATION_SHELL_BODY = `# After copying from https://agentskeptic.com/integrate: run \`agentskeptic funnel-anon set <uuid>\` once for attributed telemetry (see docs/funnel-observability-ssot.md). Optional: export AGENTSKEPTIC_VERIFICATION_HYPOTHESIS for hypothesis tagging.

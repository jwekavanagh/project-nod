...
/** Fixed `code` strings on registry readiness issues. */
export const REGISTRY_READINESS_CODE = {
  UNRESOLVED_REGISTRY_REFERENCE: "UNRESOLVED_REGISTRY_REFERENCE",
  MISSING_ENV_VAR: "MISSING_ENV_VAR",
  MISSING_WITNESS_CONFIGURATION: "MISSING_WITNESS_CONFIGURATION",
  UNSUPPORTED_WITNESS_DATABASE_MODE: "UNSUPPORTED_WITNESS_DATABASE_MODE",

...
export const REASON_CODE_TO_ORIGIN: Record<string, FailureOrigin> = {
  ...
  [SQL_VERIFICATION_OUTCOME_CODE.STATE_WITNESS_UNAVAILABLE_IN_SQLITE_FILE_MODE]: WORKFLOW_FLOW,
  [SQL_VERIFICATION_OUTCOME_CODE.STATE_WITNESS_SETUP_ERROR]: INPUTS,
  [SQL_VERIFICATION_OUTCOME_CODE.VECTOR_NOT_FOUND]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.VECTOR_METADATA_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.VECTOR_PAYLOAD_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.VECTOR_PROVIDER_ERROR]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.OBJECT_MISSING]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.OBJECT_DIGEST_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.OBJECT_SIZE_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.OBJECT_METADATA_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.OBJECT_TOO_LARGE_FOR_HASH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.HTTP_WITNESS_STATUS_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.HTTP_WITNESS_ASSERTION_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.HTTP_WITNESS_NETWORK_ERROR]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.MONGO_DOCUMENT_MISSING]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.MONGO_VALUE_MISMATCH]: DOWNSTREAM,
...
export const RUN_LEVEL_CODE_TO_ORIGIN: Record<string, FailureOrigin> = {
  ...
  LANGGRAPH_CHECKPOINT_TRUST_NON_V3_TOOL_OBSERVED: INPUTS,
  [TEST_BLOCKING_CODE]: WORKFLOW_FLOW,
};
